<x-admin-layout>
    <h3 class="text-3xl font-medium text-gray-700">Orderan Dibatalkan</h3>
                    ...
                    @forelse ($orders as $order)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <a href="{{ route('admin.orders.edit', $order) }}" class="text-indigo-600 hover:text-indigo-900">Detail</a>
                            </td>
                        </tr>
                    @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-gray-500">
                                Tidak ada orderan yang dibatalkan.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
